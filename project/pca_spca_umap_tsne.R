library(dplyr)
matrix_1 <- read.csv(file = 'C:/Users/Marcin/Documents/Ela_mzsb/matrix.csv')
population <- read.csv(file ='C:/Users/Marcin/Documents/Ela_mzsb/igsr_populations.tsv', sep='\t')
